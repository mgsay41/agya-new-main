    ...
    <div className="px-4 md:px-8 lg:px-[150px]">
      ...
      <div className="flex flex-col md:flex-row my-6 md:my-10">
        ...
        <div className="w-full md:ml-4">
          ...
          {/* Hero Section */}
          <div className="flex flex-col md:flex-row justify-between bg-[#f8f5f1] rounded-xl p-4">
          ...
          <div className="mt-5">
            <h3 className="text-left mt-4 my-4 text-xl">Research interests</h3>
            {/* History Timeline */}
            <div className="bg-[#f8f5f1] p-4 md:p-5 rounded-xl mb-4">
            ...
            {/* Cultural Heritage */}
            <div className="bg-[#f8f5f1] p-4 md:p-5 rounded-xl">
          ...
          <div className="my-6">
            <h3 className="text-left mt-4 my-4 text-xl">
          ...
          <div className="my-6">
            <h3 className="text-left mt-4 my-4 text-xl">Collaborations</h3>
