            ...
            <div className=" flex justify-between bg-secondary rounded-xl">
              <div className=" flex flex-col justify-center items-center text-center">
                ...
                <p className=" text-sm px-5">
                  ...
                  <br /> conservation exploration. <br /> Connect with fellow
                  enthusiasts, share knowledge, and collaborate on projects.
                  Discover a world of ancient civilizations and modern
                  preservation efforts. Join our community and be part of the
                  future <br /> of heritage.
                </p>
              </div>
            ...
            <div className=" my-4">
              ...
              <div className=" flex justify-between gap-4  ">
                ...
                <div className=" border py-8 px-4 flex flex-col justify-center items-center text-center  border-black/40 rounded-xl ">
                  ...
                  />
                  <p className=" font-bold text-xs w-[140px] ">
                    Provide community for knowledge exchange and scientific
                    topics discussions
                  </p>
                </div>
                <div className=" border py-8 px-4 flex flex-col justify-center items-center text-center  border-black/40 rounded-xl ">
                  <img
                    alt=""
                    className="w-8 mb-4"
                    src="/grommet-icons_book.png"
                  />
                  <p className=" font-bold text-xs w-[140px]  ">
                    Provide educational materials for enthusiasts and
                    professionals
                  </p>
                </div>
              </div>
