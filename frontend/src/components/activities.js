...
const ActivityCard = ({
  ...
  return (
    <div className="border rounded-lg overflow-hidden w-full flex flex-col lg:flex-row">
      ...
      <div className="lg:w-2/3 w-full p-4 flex flex-col justify-between">
        <div>
          ...
          <div className="flex items-center text-sm text-gray-500 space-x-2 mb-2">
            <HiOutlineTicket className="w-5 h-5 text-main" />
            <span>{price || "Free"}</span>
          </div>
          <div className="flex items-center text-sm text-gray-500 space-x-2">
            <MdOutlinePersonOutline className="w-5 h-5 text-main" />
        ...
        <div className="flex justify-between items-center pt-4">
          ...
          <button
            ...
            onClick={() => navigate(`/activities/${_id}`)}
          >
            Details
          </button>
        </div>
...
const LatestActivityCard = ({
  ...
  return (
    <div
      className="border cursor-pointer rounded-lg overflow-hidden min-w-[250px] sm:min-w-[300px] flex-shrink-0"
      onClick={() => navigate(`/activities/${_id}`)}
    >
        ...
        <button
          ...
          className={`${
            selectedCategory === category
              ...
              : "bg-[#f7fffc] text-black hover:bg-main/90 hover:text-white"
          }  text-sm px-4 mb-2 py-2 rounded-[10px] transition`}
  ...
  return (
    <div className="pr-52">
      <div className="flex flex-col lg:flex-row relative overflow-hidden">
        <div className="flex flex-col w-full lg:w-3/4 px-4 lg:px-8">
          ...
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-xl">Shared Activities</h3>
              ...
              filteredData.length > 2 && (
                <div className="flex gap-4">
                  ...
                  <button
                    ...
                    disabled={scrollPosition >= (filteredData.length - 2) * 300}
                  >
                    <ChevronRight />
                  </button>
                </div>
          ...
          <h2 className="text-xl mb-4">All Activities</h2>
          <Categories
